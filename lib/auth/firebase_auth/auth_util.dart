...
DocumentReference? get currentUserReference =>
    loggedIn ? UserCollectionsRecord.collection.doc(currentUser!.uid) : null;

UserCollectionsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserCollectionsRecord.getDocument(
                  UserCollectionsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
