                ...
                children: [
                  Align(
                    ...
                    child: StreamBuilder<List<AlertsRecord>>(
                      stream: _model.postquery(
                        requestFn: () => queryAlertsRecord(
                          queryBuilder: (alertsRecord) => alertsRecord
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<AlertsRecord> columnMainAlertsRecordList =
                            snapshot.data!;
                        ...
                        return SingleChildScrollView(
                          ...
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            children:
                                List.generate(columnMainAlertsRecordList.length,
                                    (columnMainIndex) {
                              final columnMainAlertsRecord =
                                  columnMainAlertsRecordList[columnMainIndex];
                              return Padding(
                                padding: EdgeInsets.all(18.0),
                                child: FutureBuilder<AlertsRecord>(
                                  future: AlertsRecord.getDocumentOnce(
                                      columnMainAlertsRecord.reference),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (containerAlertsRecord.pic !=
                                                    null &&
                                                containerAlertsRecord.pic != '')
                                              ClipRRect(
